...
EXPORTS="TERM=linux,NCCL_SOCKET_IFNAME=bond,NCCL_IB_HCA=mlx5,ROOT_DIR=/,USER_DIR=$USER,TORCH_FUSION_CACHE_DIR=$CACHE_DIR,TORCH_FUSION_OUTPUT_DIR=/netscratch/$USER/torchfusion,PYTHONPATH=$PYTHON_PATH,TORCH_HOME=$CACHE_DIR/pretrained"
NODES=1
TASKS=1
GPUS_PER_TASK=1
CPUS_PER_TASK=8
